...
class AgentEvent:
    ...
    @classmethod
    def agent_start(cls, messages: str):
        return cls(
    ...
    @classmethod
    def agent_end(cls, usage: TokenUsage | None = None, response: str | None = None):
        return cls(
    ...
    @classmethod
    def agent_error(cls, error: str | None = None, detail: str | None = None):
        return cls(
            type=AgentEventType.AGENT_ERROR,
            data={"error": error or "Unknown error", "detail": detail},
        )

    @classmethod
    def plan(cls, steps: list[dict[str, Any]]):
        return cls(
    ...
    def tool_call_complete(cls, call_id: str, name: str, result: ToolResult):
        return cls(
            ...
            data={
                ...
                "display_output": (
                    result.display_output if result.display_output is not None else result.output
                ),
